...
public:
  ...
  {
    RCLCPP_INFO(get_logger(), "Cartesian Lift + Reverse Circle (JOINT ORDER FIXED, 500Hz)");
  }
...
private:
  ...
  CallbackReturn on_deactivate(const rclcpp_lifecycle::State &) override
  {
    ...
    RCLCPP_WARN(get_logger(), "Cartesian lift node DEACTIVATED");
    return CallbackReturn::SUCCESS;
  }
  ...
  void try_initialize_from_current()
  {
    ...
    // === EXACT SAME MAPPING AS YOUR WORKING CONTROLLER ===
