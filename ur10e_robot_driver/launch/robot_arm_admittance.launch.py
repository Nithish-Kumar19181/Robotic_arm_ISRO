...
def generate_launch_description():
    ...
    wall_detection_node = TimerAction(
        ...
        actions=[
            Node(
                package='ur10e_robot_driver',
                executable='ur10e_wall_detection_node',
                name='ur10e_wall_detection_node',
                output='screen',
            )   
        ]
    )
    ...
    admittance_control_node = TimerAction(
        ...
        actions=[
            Node(
                package='ur10e_robot_driver',
                executable='ur10e_admittance_control_node',
                name='ur10e_admittance_control_node',
                output='screen',
            )   
        ]
    )
